...
**Note: This project is a Brainfuck compiler based on TCC, not an official TCC mirror, but it can still compile C files.**
...
include support (especially useful for floppy disks). Of course,
you can also use standard headers, although they are slower to compile.
...
tcc.c: **Note: tcc.c has been modified; code to transpile Brainfuck files has been added.** This file was originally used to check the code generator but has been modified.
